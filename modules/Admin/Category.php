...
class Category {
  ...
  public static function register(Manager $manager) {
    ...
    $manager->addRoute($manager->prefix . '/content/categories/parents/?:id', __CLASS__ . '::parents');
    $manager->addRoute($manager->prefix . '/content/categories/orders/?:id', __CLASS__ . '::orders');
  ...
  public function postForm($params = array()) {
    ...
    //Set poster
    $save->return = array_merge($save->returns(), array(
      'title' => input('title'),
      'poster' => $poster
    ));
  ...
  public function getList($params = array()) {
    ...
    $list = $list->orderBy('order')->load()->with('children')->getListIndented('&nbsp;&nbsp;');
