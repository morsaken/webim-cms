...
(function () {
  $(document).ready(function () {
    ...
    $(document).imagesLoaded(function () {
      // Page loader
      loader.delay(800).fadeOut(function() {
...
// Sticky header
(function () {
  var header = $('<div/>').addClass('header-bar sticky').append(
    $('.header-bar .bottom').clone()
  ).appendTo('header.main');
  var content = $('main');
...
(function () {
  ...
  var leftBar = inner.find('.left-bar');
...
// Aside menu
(function () {
  $('a[href="#aside-menu"]').magnificPopup({
    mainClass: 'mfp-aside-menu',
    type: 'inline',
    midClick: true,
...
// Mobile menu
(function () {
  $('a[href="#mobile-menu"]').magnificPopup({
    mainClass: 'mfp-mobile-menu mfp-fade',
    type: 'inline',
    midClick: true,
    closeMarkup: '<span class="mfp-close"></span>',
    removalDelay: 300
...
(function () {
  ...
  searchBtn.on('click', function (e) {
    ...
    var el = $(this);
    var searchBlock = el.parent().find('.search-block');

    if (!searchBlock.hasClass('active')) {
      searchBlock.addClass('active').fadeIn(200);
      $('input[name="q"]', searchBlock).focus();
    } else {
      searchBlock.removeClass('active').fadeOut(200);
    }
  });
...
(function () {
  $('.popup').magnificPopup({
    ...
    closeMarkup: '<span class="popup-close mfp-close"></span>',
    removalDelay: 300
  });
})();
  ...
  $(document).ready(function () {
    $(document).imagesLoaded(function () {
      sideBar.each(function () {
        ...
        el.stick_in_parent({
          parent: '.section',
          offset_top: $('.header-bar.sticky') ? 60 : 0
        });
      });
    });
  });
...
(function () {
  $(document).ready(function () {
    var slider = $('.exclusive');

    slider.find('.items').slick({
      fade: true,
      speed: 800,
      autoplay: true,
      appendArrows: slider.find('.items-control'),
