...
(function() {
 ...
 function setup($) {
  ...
  // global $ methods for blocking/unblocking the entire pages
  ...
  $.growlUI = function(title, message, timeout, onClose) {
   ...
   // Added by konapun: Set timeout to 30 seconds if this growl is moused over,
   // like normal toast notifications
   ...
   $m.mouseover(function() {
    ...
    displayBlock.fadeTo(300, 1); // make it easier to read the message by
  ...
  $.blockUI.defaults = {
   ...
   centerX : true, // <-- only effects element blocking (pages block controlled
                   // via css above)
   centerY : true,
   ...
   // enable if you want key and mouse events to be disabled for content that is
   // blocked
   bindEvents : true,
   ...
   // passed the element that has been unblocked (which is the window object for
   // pages
   ...
   // setting this will turn the cursor to a pointer, otherwise cursor defined
   // in overlayCss will be used.
   onOverlayClick : null,
